...
colabora con ella. Tiene una sola razón de cambio por esta razón cumple con SRP. También con Expert porque tiene la información 
...
namespace Ucu.Poo.GameOfLife
{
    ...
    /*La clase Program ejecuta todas las responsabilidades de las clases en una sola.
     En primer lugar lee el archivo (en clase Leer), luego crea el tablero (en clase Matriz), ejecuta el juego (en clase Lógica) 
